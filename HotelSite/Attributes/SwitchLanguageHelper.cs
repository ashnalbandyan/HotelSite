...
namespace HotelSite.Attributes
{
    public static class SwitchLanguageHelper
    {
        ...
        public static Language LanguageUrl(this HtmlHelper helper, string cultureName, string languageRouteName = "lang", bool strictSelected = false)
        {
            ...
            // check whetever the current thread ui culture is this language

            var curent_lang_name = Thread.CurrentThread.CurrentUICulture.Name.ToLower();
            var isSelected = strictSelected ? curent_lang_name == cultureName : curent_lang_name.StartsWith(cultureName);
            return new Language()
            {
                Url = url,
        ...
        public static MvcHtmlString LanguageSelectorLink(this HtmlHelper helper, string cultureName, string selectedText, string unselectedText,
